...
rockbutton = Button(optionsframe, text= "Rock", background= "pink", font= gamefont)
rockbutton.grid(row=1, column= 1, padx= 8, sticky= "nesw")
paperbutton = Button(optionsframe, text= "Paper", background= "light grey", font= gamefont)
paperbutton.grid(row=1, column= 2, padx= 8, sticky= "nsew")
scissorsbutton = Button(optionsframe, text= "Scissors", background= "light blue", font= gamefont)
